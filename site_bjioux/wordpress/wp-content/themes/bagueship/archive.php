...
<section class="section">
  <div class="container">
    <div class="eyebrow"><?php esc_html_e( 'Archives', 'bagueship' ); ?></div>
    <h1 class="headline" style="font-size:clamp(34px,6vw,72px);margin-top:12px;"><?php the_archive_title(); ?></h1>
    <div class="loop" style="margin-top:28px;">
      ...
      <?php endwhile; else : ?>
        <p class="lede"><?php esc_html_e( 'Aucun résultat dans cette archive.', 'bagueship' ); ?></p>
      <?php endif; ?>
    </div>
  </div>
</section>
